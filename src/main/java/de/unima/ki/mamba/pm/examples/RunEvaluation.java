...
import de.unima.ki.mamba.evaluation.renderer.HTMLTableRenderer;
...
public class RunEvaluation {
	...
	public static void main(String[] args) throws ParserConfigurationException, SAXException, 
		 ...
		 */
		final String OUTPUT_PATH = "src/main/resources/data/evaluation/matcher-evaluation-summary.html";
